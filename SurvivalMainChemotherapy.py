...
if __name__ == '__main__':
    ...
    #patient 12R01647 is unusable
    usable_df = usable_df[usable_df['PatientID'] != '12R01647']
    
    #print(usable_df['PCI'].value_counts())
    ...
    # # x = Dense(128, activation='relu')(x)
    # # x = Dense(64, activation='relu')(x)
    # predictions= Dense(1, activation='linear')(x) #=>best cindex at epoch 2 0.6
